...
- [1. 简介](#1-简介)
    ...
    - [1.2 特点](#12-特点)
- [2. 原理](#2-原理)
    - [2.1 发送命令格式](#21-发送命令格式)
    - [2.2 响应格式](#22-响应格式)
        - [2.2.1 成功响应](#221-成功响应)
        - [2.2.2 错误响应](#222-错误响应)
    - [2.3 异步事件](#23-异步事件)
- [3. Capabilities Negotiation模式](#3-capabilities-negotiation模式)
- [4. QMP样例](#4-qmp样例)
    - [4.1 QEMU的欢迎消息](#41-qemu的欢迎消息)
    - [4.2 执行stop命令](#42-执行stop命令)
    - [4.3 查询KVM信息](#43-查询kvm信息)
    - [4.4 错误返回](#44-错误返回)
    - [4.5 掉电事件](#45-掉电事件)
- [5. QMP与HMP区别](#5-qmp与hmp区别)
- [3. 使用](#3-使用)
    - [3.1 基于QEMU使用方式](#31-基于qemu使用方式)
    - [3.2 基于libvirtd使用方式](#32-基于libvirtd使用方式)
